...
function Main_loadTranslations(language) {
    ...
    document.querySelector("meta[name=viewport]").setAttribute('content', 'width=1920, initial-scale=1.975, maximum-scale=3.0, minimum-scale=0.86');
console.log('fix scale');
    Main_Checktylesheet();
