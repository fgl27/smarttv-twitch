...
function Vod_VideoHtml(id, valuesArray, idArray) {
    ...
    return '<div id="' + idArray[0] + id + '" class="stream_thumbnail_video"' +
        ...
        '<div id="' + idArray[6] + id + '"class="stream_info">' + valuesArray[4] + '</div>' + 
        '<div><div id="' + idArray[4] + id + '"class="stream_info" style="width: 59%; display: inline-block;">' + valuesArray[2] + '</div>' +
        '<div id="' + idArray[5] + id + '"class="stream_info" style="width: 39%; display: inline-block; float: right; text-align: right;">' + valuesArray[6] + '</div>' + '</div></div>';
}
